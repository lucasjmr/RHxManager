...
<head>
    ...
    <style>
        ...
        @media print {
            header, footer, .btn, .nav-links { display: none; }
...
<header>
    <div class="header-left">
        <h1>Payslip — ${payslip.employe.firstName} ${payslip.employe.lastName}</h1>
    </div>
    <div class="nav-links">
        <a href="payslips" class="back-btn">Back to List</a>
...
<main>
    ...
    <h2>Period: ${payslip.month} / ${payslip.year}</h2>
